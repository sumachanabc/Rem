class Condo < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :postal_code, format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'は無効です。ハイフン（-）を含めてください' } # 数字3桁、ハイフン、数字4桁の並びのみ許可する
    ...
    validates :management_company_postal_code, format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'は無効です。ハイフン（-）を含めてください' } # 数字3桁、ハイフン、数字4桁の並びのみ許可する
